...
const mediaSchema = new mongoose.Schema({
  ...
  width: Number, height: Number, duration: Number, thumbnail: String, altText: String, size: Number,
}, { _id: false });
...
const postSchema = new mongoose.Schema({
  ...
  audio:    { title: String, artist: String, url: String, cover: String },
...
postSchema.methods.isLikedBy = function (uid) { return this.likes.some(id => id.toString() === uid.toString()); };
